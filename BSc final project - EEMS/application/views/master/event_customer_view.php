<div class="modal-header">
    ...
    <small>Showing options for customer creation.</small>
</div>
</br>
<div class = "container">
            ...
            <div class = "col-md-12">
                ...
                <div class = "col-md-6">
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="col-md-8">
                            <input type = "text" placeholder = "Customer NIC" class = "form-control" id = "cus_nic_input" name = "cus_nic_input">
                        </div>
                    </div>
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="col-md-8">
                            <input type = "text" placeholder = "Customer Name" class = "form-control" id = "cus_name_input" name = "cus_name_input">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">                                            
                            ...
                            <input type="text" class="form-control" id="cus_home_input" name="cus_home_input" placeholder="Home Number">
                        </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="cus_mobile_input" name="cus_mobile_input" placeholder="Mobile Number">
                        </div>
                        </div>
                    </div>
                ...
                <div class = "col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <textarea type="text" class="form-control" id="cus_add_input" name="cus_add_input" placeholder="Customer Address" rows = "5"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="col-md-8">
                            <div class="input-group">
                                ...
                                <input type = "email" placeholder = "Email Address" class = "form-control" id = "cus_email_input" name = "cus_email_input">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-group date">
                                ...
                                <input type="text" placeholder="Registered Date" name="reg_date_input" id = "reg_date_input" value = "<?php echo date('Y-m-d'); ?>" class="form-control">
                            </div>
                        </div>
                    </div>
