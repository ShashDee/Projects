<div class = "row">
    <div class = "col-md-6">
        ...
        <ol class = "breadcrumb"> <!-- Start Breadcrumb - Give Proper Location for each link-->
            ...
            <li>
             ...
             <li class = "active">
                <a><strong>Event Lookup</strong></a>
            </li>
        </ol>
    </div>
    <!-- /.col-lg-4 -->
    <div class = "col-md-6">
        <div class="title-action">
            <a class="btn btn-primary" onclick="loadModule('transaction/event/event_view/null/a');"><i class="fa fa-plus"></i> Add New Event </a>
        </div>
    </div>
    <!-- /.col-lg-8 -->
</div>
            ...
            <div class="panel-heading">
                <!-- <div class = "col-md-5"> -->
                    <h4 class="panel-title">
                        <a data-toggle="collapse" href="#ent_collapse">Event Lookup <small class = "text-white"> Showing all existing events</small></a>
...
$(document).ready(function()
{
    ...
    ent_lookup_table = $('#ent_lookup_table').dataTable(
    {
        ...
        'responsive' : false,
         'autoWidth' : false,
        'sAjaxSource': '<?php echo site_url("transaction/event/fetch_events")?>',
        ...
        { 
            if(data.status == "On Progress")
                jQuery('td:eq(6)', row).css('background-color', '#ADF7F8');
...
function editEvent(ent_id)
{
    loadModule('transaction/event/event_view/' + ent_id + '/e');
}

function viewEvent(ent_id)
{
    loadModule('transaction/event/event_view/' + ent_id + '/v');
}
