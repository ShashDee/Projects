...
public class PlayerHealth : MonoBehaviour
{
    ...
    ObjectController playerMovement;                            // Reference to the player's movement.
    PlayerShooting playerShooting;                              // Reference to the PlayerShooting script.
    bool isDead;                                                // Whether the player is dead.
    bool damaged;                                               // True when the player gets damaged.
    bool won;                                                   // True when the game is won.
    ...
    void Awake()
    {
        ...
        playerMovement = GetComponent<ObjectController>();
    ...
    {
        // adding life when hearts are collected. Ensuring health doesn't exceed 100
        if (currentHealth <= 90) 
        {
